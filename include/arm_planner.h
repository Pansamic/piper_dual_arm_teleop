...
private:
    ...
    TrajectoryBuffer<10>& left_arm_trajectory_buffer_;
    TrajectoryBuffer<10>& right_arm_trajectory_buffer_;
    ...
    //     const std::array<JointState, plan_waypoint_amount_>& waypoints);
    /**
    ...
    void planDualArmCHOMP(
        std::array<JointState, plan_waypoint_amount_>& plan_waypoints,
